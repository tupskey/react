       ...
       <div className="container">
        ...
        <div className="col-12 col-sm-11 offset-sm-1">
            <div className="btn-group" role="group">
                ...
                <a role="button" className="btn btn-danger"  href="#"><i className="fa fa-skype"></i> Skype</a>
                <a role="button"className="btn btn-success"  href="mailto:tupskey@gmail.com"><i className="fa fa-envelope-o"></i> Email</a>
            </div>
        </div>
