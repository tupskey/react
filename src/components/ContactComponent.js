...
class  Contact extends Component {
    ...
    handleSubmit( values) {
      this.props.postFeedback(values.firstname, values.lastname, values.email, values.message, values.telnum);
       ...
       <div className="container">
        ...
        <div className="col-12 col-sm-11 offset-sm-1">
            <div className="btn-group" role="group">
                <button className="btn btn-primary" ><i className="fa fa-phone"></i> Call</button>
                <button className="btn btn-danger"  ><i className="fa fa-skype"></i> Skype</button>
                <button className="btn btn-success"  href="mailto:tupskey@gmail.com"><i className="fa fa-envelope-o"></i> Email</button>
            </div>
        </div>
